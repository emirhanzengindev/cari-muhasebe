...
COMMENT ON TABLE public.current_accounts IS 'Current accounts table with all columns including email, address, name, phone, tax_number, tax_office, company, balance, tenant_id, created_at, updated_at, is_active, account_type - schema cache refresh 20260129101834';
