...
export default function InvoiceDetail() {
  ...
  const downloadPDF = () => {
    ...
    // Add items manually since we're having issues with autotable
    doc.setFontSize(12);
