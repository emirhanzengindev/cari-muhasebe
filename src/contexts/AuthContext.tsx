  ...
  useEffect(() => {
    ...
    const checkSession = async () => {
      ...
      console.log('DEBUG: Setting tenantId from auth context:', userData.tenantId);
            console.log('DEBUG: Raw tenant ID before cleaning:', supabaseUser.user_metadata?.tenant_id);
    ...
    const { data: { subscription } } = supabase.auth.onAuthStateChange((_event, session) => {
      if (session) {
        ...
        console.log('DEBUG: Setting tenantId from auth state change:', userData.tenantId);
                console.log('DEBUG: Raw tenant ID before cleaning in auth state change:', supabaseUser.user_metadata?.tenant_id);
